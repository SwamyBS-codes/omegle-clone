...
// Use Vite env var `VITE_BACKEND_URL` when available, otherwise fall back to the ngrok backend URL
const URL = import.meta.env.VITE_BACKEND_URL || "https://rejoicing-gizzard-font.ngrok-free.dev";
